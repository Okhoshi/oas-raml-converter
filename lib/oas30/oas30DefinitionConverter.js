...
var Oas30DefinitionConverter = function (_Converter) {
	...
	_createClass(Oas30DefinitionConverter, [{
		...
		value: function _export(model) {
			...
			var attrIdSkip = ['name', 'fileReference', 'discriminator', 'reference', 'properties', 'compositionType', 'schema', 'items', 'itemsList', 'additionalProperties', 'jsonValue', 'schemaPath', 'examples', '$schema', 'id', 'annotations', 'fileTypes', 'propsRequired', 'expanded'];
