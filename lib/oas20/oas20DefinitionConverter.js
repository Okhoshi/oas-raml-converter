...
var Oas20DefinitionConverter = function (_Converter) {
	...
	_createClass(Oas20DefinitionConverter, [{
		...
		value: function _export(model) {
			...
			var attrIdSkip = ['name', 'fileReference', 'reference', 'properties', 'compositionType', 'schema', 'items', 'itemsList', 'additionalProperties', 'jsonValue', 'schemaPath', 'examples', '$schema', 'id', 'fileTypes', 'annotations', 'includePath', 'expanded'];
		...
		value: function _import(oasDef) {
			...
			var attrIdSkip = ['enum', '$ref', 'properties', 'allOf', 'schema', 'items', 'additionalProperties', 'example', 'required'];
